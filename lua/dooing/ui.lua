...
create_help_window = function()
	...
	local help_content = {
		" Main window:",
		string.format(" %-6s - Add new to-do", keys.new_todo),
		string.format(" %-6s - Toggle to-do status", keys.toggle_todo),
		string.format(" %-6s - Delete current to-do", keys.delete_todo),
		string.format(" %-6s - Delete all completed todos", keys.delete_completed),
		string.format(" %-6s - Close window", keys.close_window),
		string.format(" %-6s - Add due date to to-do", keys.add_due_date),
		string.format(" %-6s - Remove to-do due date", keys.remove_due_date),
		string.format(" %-6s - Add time estimation", keys.add_time_estimation),
		string.format(" %-6s - Remove time estimation", keys.remove_time_estimation),
		string.format(" %-6s - Toggle this help window", keys.toggle_help),
		string.format(" %-6s - Toggle tags window", keys.toggle_tags),
		string.format(" %-6s - Clear active tag filter", keys.clear_filter),
		string.format(" %-6s - Edit to-do item", keys.edit_todo),
		string.format(" %-6s - Edit to-do priorities", keys.edit_priorities),
		string.format(" %-6s - Undo deletion", keys.undo_delete),
		string.format(" %-6s - Search todos", keys.search_todos),
		string.format(" %-6s - Import todos", keys.import_todos),
		string.format(" %-6s - Export todos", keys.export_todos),
		string.format(" %-6s - Remove duplicates", keys.remove_duplicates),
		string.format(" %-6s - Open todo scratchpad", keys.open_todo_scratchpad),
		string.format(" %-6s - Toggle priority", keys.toggle_priority),
		"",
		" Tags window:",
		string.format(" %-6s - Edit tag", keys.edit_tag),
		string.format(" %-6s - Delete tag", keys.delete_tag),
		" <CR>  - Filter by tag",
		string.format(" %-6s - Close window", keys.close_window),
		"",
		" Calendar window:",
		string.format(" %-6s - Previous day", config.options.calendar.keymaps.previous_day),
		string.format(" %-6s - Next day", config.options.calendar.keymaps.next_day),
		string.format(" %-6s - Previous week", config.options.calendar.keymaps.previous_week),
		string.format(" %-6s - Next week", config.options.calendar.keymaps.next_week),
		string.format(" %-6s - Previous month", config.options.calendar.keymaps.previous_month),
		string.format(" %-6s - Next month", config.options.calendar.keymaps.next_month),
		string.format(" %-6s - Select date", config.options.calendar.keymaps.select_day),
		string.format(" %-6s - Close calendar", config.options.calendar.keymaps.close_calendar),
		"",
	}
